...
namespace TestLibVLCSharp
{
    public partial class Form1 : Form
    {
        ...
        private async void btnGo_Click(object sender, EventArgs e)
        {
            ...
            {
                using (LibVLC _libVLC = new LibVLC("--preferred-resolution=" + cboResolution.SelectedItem.ToString().Split(',')[0]))
                {
            ...
            {
                LibVLC _libVLC = new LibVLC("--preferred-resolution=" + cboResolution.SelectedItem.ToString().Split(',')[0]);
